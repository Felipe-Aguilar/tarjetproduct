                ...
                >
                    ...
                    <div className='row justify-content-between align-items-center'>
                        ...
                        <div className='w-auto menu-circle'>
                            ...
                            <NavLink to="/Tarjetas3" className='active'>
                                <i className="bi bi-circle-fill"></i>
                            </NavLink>
                        </div>
                    </div>
                    ...
                    <div className='row mt-4 justify-content-end'>
                        <div className='w-auto'>
                            <h6>Construcción General</h6>
                        </div>
                    </div>

                    <div className='row mt-3 informacion'>
                        <div className='w-50 left'>
                            <NavLink to="/">Sr. Alfredo Chávez</NavLink>
                            <NavLink to="/">Mtro. Rodolfo Cotta</NavLink>
                            <NavLink to="/">Sr. Herminio González</NavLink>
                            <NavLink to="/">Sr. Hector Filemón</NavLink>
                        </div>
                        <div className='w-50 right'>
                            <NavLink to="/">Sr. Omar Benabidez</NavLink>
